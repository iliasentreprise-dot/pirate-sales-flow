...
function PayPalSection({ bumpAdded }: { bumpAdded: boolean }) {
  ...
  const amount = bumpAdded ? "444.00" : "397.00";
    ...
    <div style={{ background: "#0a0a0a", color: "#f2ead8", fontFamily: "'DM Sans', sans-serif", minHeight: "100vh" }}>
      ...
      <div className="ob-summary-box">
        <div className="ob-order-summary">
          ...
          <div className="ob-order-line"><span>🤖 Système DigiDrop (méthode complète)</span><span className="price">397€</span></div>
          {bumpAdded && (
        ...
        {(() => {
          const revolutLink = bumpAdded
            ? "https://revolut.me/ilias_business?currency=EUR&amount=44400&note=Formation%20%20%20Logiciel%20d%27automatisation"
            : "https://revolut.me/ilias_business?currency=EUR&amount=39700&note=Le%20Syst%C3%A8me%20pirate%20complet";
          const amountLabel = bumpAdded ? "444€" : "397€";
          return (
            <button
              onClick={() => {
                if (!validateFields(customerName, customerEmail, setFieldError)) return;
        ...
        {(() => {
          ...
          const klarnaInstalment = bumpAdded ? "3x 148€" : "3x 132,33€";
          return (
            <>
              <button
